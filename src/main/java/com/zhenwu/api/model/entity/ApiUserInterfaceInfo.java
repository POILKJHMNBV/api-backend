...
/**
 * 用户调用接口关系表
 * @TableName api_user_interface_info
 */
@TableName(value ="api_user_interface_info")
@Data
public class ApiUserInterfaceInfo implements Serializable {

    @TableField(exist = false)
    private static final long serialVersionUID = -7882089007037140199L;
    /**
     * 主键
     */
    ...
    public boolean equals(Object that) {
        ...
        ApiUserInterfaceInfo other = (ApiUserInterfaceInfo) that;
