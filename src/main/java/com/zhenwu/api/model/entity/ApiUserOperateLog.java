...
/**
 * 用户操作日志表
 * @TableName api_user_operate_log
 */
@TableName(value ="api_user_operate_log")
@Data
public class ApiUserOperateLog implements Serializable {

    @TableField(exist = false)
    private static final long serialVersionUID = 5598127422515930433L;
    /**
     * 主键
     */
    @TableId
    ...
    public boolean equals(Object that) {
        ...
        ApiUserOperateLog other = (ApiUserOperateLog) that;
